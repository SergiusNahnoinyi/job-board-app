      ...
      <main>
        ...
        <div className="h-30 md:56 bg-slate-200">
          <Image
            ...
            src={`https:${company.fields.coverImage.fields.file.url}`}
            width={company.fields.coverImage.fields.file.details.image.width}
            height={company.fields.coverImage.fields.file.details.image.height}
            alt={company.fields.coverImage.fields.title}
          />
        </div>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
          <div className="max-w-3xl mx-auto">
            <h3 className="text-xl leading-snug text-slate-800 font-bold mb-6">
              Open Positions at {company.fields.name}
            </h3>

            {/* Job lists */}
            <div className="space-y-6">
              {/* Job category list */}
              <JobsList jobs={companyJobs} />
            </div>
